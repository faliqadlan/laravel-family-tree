    ...
    <div class="space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                     <a href="{{ route('filament.app.resources.duplicate-checks.index', ['tenant' => auth()->user()->currentTeam]) }}" 
                   class="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    ...
                    <div>
                     ...
                     <a href="{{ route('filament.app.resources.smart-matches.index', ['tenant' => auth()->user()->currentTeam]) }}" 
                   class="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    ...
                    <div>
                     ...
                     <a href="{{ route('filament.app.resources.dnas.create', ['tenant' => auth()->user()->currentTeam]) }}" 
                   class="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
